...
# from bytelatent.args import dataclass_from_dict
...
class StoolArgs(BaseModel):
    ...
    dependency: str = ""  # The job dependency, e.g. afterok:12345
...
"""
    ...
    if args.launcher == "sbatch":
        os.system(f"cd $PROJECT && sbatch {dump_dir}/submit.slurm")
    else:
...
if __name__ == "__main__":
    ...
    args = StoolArgs.model_validate(OmegaConf.to_container(args, resolve=True))
    launch_job(args)
